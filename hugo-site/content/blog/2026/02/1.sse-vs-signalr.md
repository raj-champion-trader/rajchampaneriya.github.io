...
When building the [Stock Market Simulator](https://github.com/rajchampaneriya/stock-market-simulator)—a living laboratory for event-driven patterns that doesn't care about your feelings, only throughput—one of the first architectural decisions was: **How do we push real-time price updates to thousands of concurrent users efficiently?**
...
**Architecture Decisions**: [ADRs — SSE vs SignalR, Redis Streams vs Kafka, and more](https://github.com/rajchampaneriya/stock-market-simulator/tree/main/reference-docs)

---

*Questions or feedback? Let's discuss on [GitHub Issues](https://github.com/rajchampaneriya/stock-market-simulator/issues).*
