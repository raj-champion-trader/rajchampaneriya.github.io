...
tags: ["rail-vocabulary", "rail-engineering", "industry-knowledge", "professional-development", "IBM"]
...
You've heard the phrase "points failure causing delays" a hundred times. On the PA system at Central Station, in the app notification on your phone, in the resigned sigh of the commuter next to you.
...
And one of those terms — *gauge* — reveals a 170-year-old mistake that Australia is still paying for.
...
Rail vocabulary isn't passive knowledge — it's a systems-thinking tool. These eight terms — possession, rolling stock, ballast, gauge, sleeper, overhead wiring, intermodal, and siding — are interconnected components of a single operating system.
...
| Term | Definition |
|------|-----------|
| **Possession** | A scheduled period when track is closed to trains for maintenance work |
| **Rolling stock** | All vehicles running on railway tracks: locomotives, passenger carriages, freight wagons, and maintenance vehicles |
| **Gauge** | The distance between rail inner faces; Australia operates Standard (1,435mm), Broad (1,600mm), and Narrow (1,067mm) gauges |
