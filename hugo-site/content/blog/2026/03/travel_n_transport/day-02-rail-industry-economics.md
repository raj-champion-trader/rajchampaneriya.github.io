...
That was decades ago. Today, those trains are part of a $38.8 billion industry that employs over 40,000 people and underpins Australia's entire export economy.
...
1. **Evaluate:** Given that passenger rail farebox recovery is only 30–50%, what evidence would you use to argue that public subsidy represents a net economic benefit rather than a market distortion?
2. **Evaluate:** How would you assess whether Australia's above-rail/below-rail separation model delivers better outcomes than Japan's vertically integrated model?
3. **Create:** Design a dashboard that would give a rail CEO a real-time view of revenue health across all five revenue streams — what metrics would you include?
...
Aurizon's FY2025 results reveal a **12% increase in freight revenue** driven by record iron ore and bulk haulage volumes, underscoring how commodity cycles directly shape Australian rail economics and maintenance investment capacity.
...
| Type | Source |
|------|--------|
| IBM | IBM Institute for Business Value — *"Revenue Optimization in Asset-Intensive Transportation"* (2024) |
| IBM | IBM Consulting — *"Travel & Transportation Industry Economic Models"* (ibm.com/consulting) |
| Industry | Australasian Railway Association — *"Moving Australia: Annual Report 2024"* (ara.net.au) |
| Government | ACCC — *"Australian Rail Access Regulation: Pricing Principles"* (accc.gov.au) |
| Government | BITRE — *"Australian Infrastructure Statistics Yearbook 2024"* (bitre.gov.au) |
