...
Sydney chose double-deck trains in the 1960s — a bet on maximising seats per train. Melbourne chose single-deck — a bet on faster boarding (more doors, level platforms) and [higher service frequency](https://en.wikipedia.org/wiki/Melbourne_rail_network).
...
Melbourne operates [250 km of tram routes — the largest tram network in the world](https://www.yarratrams.com.au/about-us). It fills a specific capacity niche: too much demand for buses, not enough for heavy rail.
...
[Metro Trains Melbourne](https://www.metrotrains.com.au/) operates under a [government franchise contract](https://www.ptv.vic.gov.au/footer/about-ptv/who-we-work-with/). The state owns the assets. Metro Trains provides operations and maintenance. Payment is tied to performance metrics: on-time running, customer satisfaction, safety.
...
**Automation** is already here: [Sydney Metro operates fully driverless (GoA 4)](https://www.sydneymetro.info/about), demonstrating that established urban rail services can run without drivers. The impact is transformational — higher frequency, faster recovery from disruptions, lower per-service operating costs.

**Predictive maintenance** targets the cost base: reducing unplanned failures means fewer service disruptions, lower emergency repair costs, and better asset utilisation. [IBM Maximo Health and Predict](https://www.ibm.com/products/maximo/predictive-maintenance) is designed precisely for this use case.

**Mobility-as-a-Service (MaaS)** targets the demand side: integrating rail with ride-share, bike-share, and bus in a single platform, solving the [first/last mile problem](https://en.wikipedia.org/wiki/Last_mile_(transportation)) that keeps passengers in their cars.
...
1. **Asset management ([Maximo](https://www.ibm.com/products/maximo)):** Rolling stock maintenance for fleets of 500+ carriages, where extending asset life by even 5% saves tens of millions
2. **Demand forecasting ([watsonx](https://www.ibm.com/watsonx)):** Predicting passenger demand by route, time, and day — enabling dynamic timetabling that matches capacity to actual need
3. **Cybersecurity ([QRadar](https://www.ibm.com/products/qradar-siem)):** Protecting increasingly connected rail operations — from CCTV networks to passenger Wi-Fi to signalling systems — against threats that grow as connectivity increases
...
| Industry | [Australasian Railway Association](https://www.ara.net.au/) — *"Passenger Rail in Australia: State of the Industry 2024"* |
| Government | [Transport for NSW](https://www.transport.nsw.gov.au/) — *"Sydney Metro: Program Business Case Summary"* |
| Government | [BITRE](https://www.bitre.gov.au/) — *"Urban Rail Patronage Statistics 2024"* |
| Operator | [MTR Corporation](https://www.mtr.com.hk/en/corporate/overview/profile_index.html) — *Annual Report & Sustainability Report* |
| Operator | [Metro Trains Melbourne](https://www.metrotrains.com.au/) — *Franchise Performance Data* |
| Government | [Public Transport Victoria](https://www.ptv.vic.gov.au/) — *Network Performance Reports* |
| Statistics | [Australian Bureau of Statistics](https://www.abs.gov.au/statistics/people/population) — *Regional Population Growth Data* |
